...
class Emagister(scrapy.Spider):
    ...
    for i in xrange(1,226):
        ...
        start_urls.append('http://www.emagister.fr/web/search/?searchAction=search&segment=&idsegment=1&rangoPrecioMax=13&rangoPrecioMin=23&idCategSeg=2&idFiltroDuracionMax=20&idFiltroDuracionMin=10&p='+str(i))
