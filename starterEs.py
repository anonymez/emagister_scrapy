...
class Emagister(scrapy.Spider):
    ...
    for i in xrange(1,56):
        ...
        start_urls.append('http://www.emagister.com/web/search/?searchAction=tematica&segment=&idsegment=1&p='+str(i)+'&rangoPrecioMax=13&rangoPrecioMin=23&idCategSeg=2&idFiltroDuracionMax=20&idFiltroDuracionMin=10')
