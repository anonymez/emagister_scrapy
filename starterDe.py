...
class Emagister(scrapy.Spider):
    ...
    for i in xrange(1,123):
        ...
        start_urls.append('http://www.emagister.de/web/search/?searchAction=search&segment=&idsegment=1&p='+str(i)+'&rangoPrecioMax=13&rangoPrecioMin=23&idFiltroDuracionMax=20&idFiltroDuracionMin=10&idCategSeg=2')
