...
class Emagister(scrapy.Spider):
    ...
    for i in xrange(1,176):
        ...
        start_urls.append('http://www.emagister.co.uk/web/search/?searchAction=search&segment=&idsegment=1&p='+str(i)+'rangoPrecioMax=13&rangoPrecioMin=23&idCategSeg=115&idFiltroDuracionMax=20&idFiltroDuracionMin=10')
